# taken from here: https://github.com/vchoutas/smplx/blob/main/smplx/lbs.py
# Unfortunatly, there are some clunkly and unecessary dependencies in the original code
# This is an attempt into simplifiying it.

# This is an "in-code" copy of https://github.com/vchoutas/smplx/tree/main

# We do this to avoid some of the clunky deps (chumpy, numpy<=1.23) etc
...
from humanposer.smplx.vertex_ids import vertex_ids as VERTEX_IDS
from humanposer.smplx.utils import (
    Struct,
    StructOld,
    to_np,
    to_tensor,
...
from humanposer.smplx.vertex_joint_selector import VertexJointSelector
        ...
        **kwargs,
        ...
        if data_struct is None:
            ...
            if osp.isdir(model_path):
                model_fn = "SMPL_{}.{ext}".format(gender.upper(), ext="npz")
                smpl_path = os.path.join(model_path, model_fn)
            else:
                smpl_path = model_path
            assert osp.exists(smpl_path), "Path {} does not exist!".format(smpl_path)

            struct = np.load(smpl_path, allow_pickle=True)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if data_struct is None:
            ...
            data_struct = StructOld(**model_data)
